...
f_P_Nu <- function(beta,A2,Phi,Nu,tau,m2loglike_old,Phi_m,sd_Phi,Nu_m,sd_Nu,status){
  ...
  logproposal <- log(dtruncnorm(Phi[1],a = 500,b = 3500,mean = Phi_m[1],sd = sd_Phi[1]))
...
save(MCMC_results, file=paste0("sim_res/chain",variable_narccap,model,type,'NARCCAP_PSL',".Rdata"))
