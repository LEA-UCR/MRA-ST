---
title: "Resultados y Diagnósticos-INLA-ST_E0A-MODELO_0"
output:
  html_document:
    df_print: paged
---
...
Calcula métricas y resultados del escenario 0 en Barboza et al, 2022. Carga de resultados:
```{r}
load('results/results_INLA_ST_E0a.RData')
```
...
knitr::kable(resumenObs_year,digits = 2)
knitr::kable(resumenObs_month,digits = 2)

write_csv(x = resumenObs_year,file = 'tabla_res_0.csv')
```
