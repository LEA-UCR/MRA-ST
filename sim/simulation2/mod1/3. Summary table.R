...
colnames(time.exec) <- paste0("IID",nres)

write_csv(coef.summary.list1,file = paste0("metrica_IID",nres,".csv"))
write_csv(prediction.table,file = paste0("metrica_pred_IID",nres,".csv"))
write_csv(time.exec, file = paste0("time_exec_IID",nres,".csv"))
